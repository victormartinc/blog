...
description: "Abro un cuaderno para escribir las decisiones que normalmente se quedan en la cabeza. Qué habrá, por qué no hay calendario, y por qué en tres idiomas."
date: 2026-07-29
...
añado es quitarle el calendario de encima, que para mí es lo que hace que
sobreviva.
:::

## Sin calendario

Escribir por calendario me saldría mal. Lo he probado, y el resultado
previsible son apuntes a medias publicados por no romper la racha. Así que
aquí no hay periodicidad: la unidad no es la semana ni el mes, es el
**número**. Numerado y fechado, como una revista pequeña que sale cuando
tiene algo que decir.

Puede que un mes haya tres y que al siguiente no haya ninguno. Eso no es
dejadez: es la condición. Lo que decide que un número salga no es la fecha,
es que la idea haya aguantado. Lo que parece brillante un jueves a las once
de la noche a menudo no sobrevive tres semanas después, y es mejor
descubrirlo antes de publicarlo que después.

:::destacat
Publicar por calendario acaba siendo rellenar páginas. Un número sale cuando
la idea ha aguantado el enfriamiento, y no antes.
:::
...
decide dónde existe**. Traducirlo todo sería triplicar el trabajo que menos
me aporta, y el resultado previsible es dejar de escribir.
